...
![Phonebook App Books Page](./books.png)

![Phonebook App Add Page](./add.png)

![Phonebook App Edit Page](./edit.png)

## Steps to Solution

- Step 1: Create project folder for local public repo on your pc

- Step 2: Prepare scripts to build a Python Flask App Image using Dockerfile and Docker Compose

- Step 3: Prepare a Terrform configuration file to deploy your app on EC2 Instance
